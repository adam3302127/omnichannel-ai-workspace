-- Migration: Add pgvector + Gemini embeddings for semantic RAG
-- Run in Supabase SQL editor after enabling pgvector extension in Dashboard.
-- Enable extension: Database > Extensions > vector
